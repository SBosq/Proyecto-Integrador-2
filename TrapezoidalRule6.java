...
public class TrapezoidalRule6
{
    ...
    {
        return -0.007264*Math.pow(x,2)+0.577334*x+0.000347; //ideally we want to place the function created by the parabolic throw of the soccer ball
    }
    /**********************************************************************

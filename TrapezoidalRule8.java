...
public class TrapezoidalRule8
{
    ...
    {
        return -0.021792*Math.pow(x,2)+1.73201*x+0.000866; //ideally we want to place the function created by the parabolic throw of the soccer ball
    }
    /**********************************************************************

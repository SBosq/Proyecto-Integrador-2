...
public class TrapezoidalRule4
{
    ...
    {
        return -0.015691*Math.pow(x,2)+x+0.000026; //ideally we want to place the function created by the parabolic throw of the soccer ball
    }
    /**********************************************************************

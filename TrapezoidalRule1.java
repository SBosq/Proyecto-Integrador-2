...
public class TrapezoidalRule1
{
    ...
    {
        return -0.044172*Math.pow(x,2)+0.999992*x+0.000074; //ideally we want to place the function created by the parabolic throw of the soccer ball
    }
    /**********************************************************************

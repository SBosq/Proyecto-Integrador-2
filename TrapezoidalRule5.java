...
public class TrapezoidalRule5
{
    ...
    {
        return -0.031381*Math.pow(x,2)+1.73205*x+0.000003; //ideally we want to place the function created by the parabolic throw of the soccer ball
    }
    /**********************************************************************

...
public class TrapezoidalRule3
{
    ...
    {
        return -0.010461*Math.pow(x,2)+0.577384*x-0.000509; //ideally we want to place the function created by the parabolic throw of the soccer ball
    }
    /**********************************************************************

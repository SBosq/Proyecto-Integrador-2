...
public class TrapezoidalRule2
{
    ...
    {
        return -0.088344*Math.pow(x,2)+1.73205*x+0.000009; //ideally we want to place the function created by the parabolic throw of the soccer ball
    }
    /**********************************************************************
